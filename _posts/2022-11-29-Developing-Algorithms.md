...
This algorithm takes the input of num and num2 and sees if num is divisible by num2. If true then output is true. Else the output is false. </li>
<li>What if I put in 30 as num and 4 as num2. What would be the output?
The output would be false because 30 is not divisible by 4. </li>
</ol>
...
To make them the same output you could use an elif statement instead of three consequent if statements.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">function</span><span class="p">(</span><span class="n">num</span><span class="p">):</span>
...
<span class="n">function</span><span class="p">(</span><span class="mi">6</span><span class="p">)</span>
</pre></div>
